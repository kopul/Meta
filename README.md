...
Meta is a fork of Raven b+ which was built on top of Raven b3 that I have definitely improved with a large array of new *features*
...
3. Open command prompt/terminal and type ./gradlew build
