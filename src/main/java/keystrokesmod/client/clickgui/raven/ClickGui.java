...
public class ClickGui extends GuiScreen {
   ...
   public void drawScreen(int x, int y, float p) {
      ...
      this.drawCenteredString(this.fontRendererObj, "M", halfScreenWidth - w_c, quarterScreenHeight - 22, Utils.Client.rainbowDraw(2L, 1500L));
      this.drawCenteredString(this.fontRendererObj, "e", halfScreenWidth - w_c, quarterScreenHeight - 10, Utils.Client.rainbowDraw(2L, 1200L));
      this.drawCenteredString(this.fontRendererObj, "t", halfScreenWidth - w_c, quarterScreenHeight + 1, Utils.Client.rainbowDraw(2L, 900L));
      this.drawCenteredString(this.fontRendererObj, "a", halfScreenWidth - w_c, quarterScreenHeight + 12, Utils.Client.rainbowDraw(2L, 300L));
      this.drawCenteredString(this.fontRendererObj, "b1", halfScreenWidth + w_c, quarterScreenHeight + 27, Utils.Client.rainbowDraw(2L, 0L));
      ...
      if(latestVersion.isNewerThan(clientVersion)){
         ...
         mc.fontRendererObj.drawString("Meta b1 " + " | Config: " + Raven.configManager.getConfig().getName(), 4, this.height - 3 - mc.fontRendererObj.FONT_HEIGHT, Utils.Client.astolfoColorsDraw(10, 14, speed));
      }
